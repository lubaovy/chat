...
from python_rag_llm_base_public_main.ingestion.service_manager import ServiceManager
...
class Retriever:
    ...
    def __init__(self, embedding_model_name: str, faiss_fetch_k: int = 200):
        """
    ...
    def get_documents(self, query: str, num_doc: int = 5):
        ...
        """
        #print("Mô hình embedding đang sử dụng:", self.embedding_model.__class__.__name__)
