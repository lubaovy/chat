...
class QuestionAnalyzer:
    ...
    def analyze(self, question: str) -> dict:
        prompt = f"""
Bạn là trợ lý AI chuyên phân tích truy vấn người dùng về lịch sử.
...
Nếu phát hiện câu hỏi có chứa lỗi kiến thức, hãy trả về `valid: false`.
...
class QuestionEnricher:
    ...
    def enrich(self, question: str) -> str:
        prompt = f"""
Bạn là chuyên gia cải thiện truy vấn cho chatbot lịch sử.  
